...
-- Hôte : db.3wa.io
-- Utilisateur : argon71hotmailfr
-- Mot de passe : 1b6d9c41e962f51b032b2fbc3a06cba1
-- Base de données : argon71hotmailfr_permut
...
-- Insertion de données dans la table `alertes` --
...
-- Insertion de données dans la table `departments` --
...
-- Insertion de données dans la table `grades` --
...
-- Insertion de données dans la table `qualification` --
...
-- Insertion de données dans la table `sectors` --
...
-- Insertion de données dans la table `statuts` --
...
-- Création de la table `statutsalertes` --
CREATE TABLE `statutsalertes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
-- Insertion de données dans la table `statutsalertes` --
...
-- Création de la table `usersDetails` --
...
-- Insertion de données dans la table `usersDetails` --
